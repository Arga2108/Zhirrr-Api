...
loghandler = {
    notparam: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'mana apikeynya',
        getApikey: 'gak punya apikey? chat gw https://wa.me/6285752164908 (gratis)'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/6285752164908 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'arganiboss') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'arganiboss') return res.json(loghandler.invalidKey)
